...
// REUSABLE FUNCTIONS TO GENERATE STATISTICS  **********************************************

// Comparative Manure production by months
function compareManureProductionByMonths(parameters) {
    ...
    data.forEach(element => {
        ...
        // Last year
        if (Number(element.year) === period-1) {
            if (Number(element.month) === 1) {
...
const manureProduction = createSlice({
    ...
    extraReducers: {
        ...
        [getManureProductionOnCountryLevel.fulfilled] : (state, action) => {
            ...
            const comparativeManureProduction = compareManureProductionByMonths({data: action.payload.manureProduction, period: action.payload.periodValue});
            ...
            // Generating a list of production per district
        ...
        [getManureProductionOnDistrictLevel.fulfilled] : (state, action) => {
            ...
            state.comparativeManureProductionStatsDistrictLevel = comparativeManureProduction;
        ...
        [getManureProductionOnMCCLevel.fulfilled] : (state, action) => {
            ...
            state.comparativeManureProductionStatsMCCLevel = comparativeManureProduction;
