...
function compareMilkProductionByMonths(parameters) {
...
const milkProduction = createSlice({
    ...
    extraReducers: {
        ...
        [getMilkProductionOnCountryLevel.fulfilled] : (state, action) => {
            ...
            const comparativeMilkProduction = compareMilkProductionByMonths({data: action.payload.milkProduction, period: action.payload.periodValue});
        ...
        [getMilkProductionOnDistrictLevel.fulfilled] : (state, action) => {
            ...
            state.comparativeMilkProductionStatsDistrictLevel = comparativeMilkProduction;
        ...
        [getMilkProductionOnMCCLevel.fulfilled] : (state, action) => {
            ...
            state.comparativeMilkProductionStatsMCCLevel = comparativeMilkProduction;
